...
**Refine**: takes your existing full prompt and strengthens weak areas, adds missing technical detail, and enforces the realism mandate. Preserves your intent and structure.
...
3. **Direct input**: paste into the `api_key` field on the node (not recommended, it's visible in workflow JSON)
